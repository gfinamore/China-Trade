...
caminho_arquivo = r # Escreva o caminho do arquivo aqui
...
# Extração para Métrica 1 (Dependência)
...
# Extração para Métrica 2 (Balança Comercial)
...
# 5. Execução do K-Means Final com k=3
